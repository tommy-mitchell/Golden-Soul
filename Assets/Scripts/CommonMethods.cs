...
namespace CommonLibrary
{
    public static class CommonMethods
    {
        ...
        public static bool CheckInput(int mouseButton, KeyCode key)
        {
            return Input.GetMouseButtonDown(mouseButton) || Input.GetKeyDown(key);
        }
        ...
        public static Transform GetRootManager() => GameObject.Find("Root Manager").transform;
    }
}